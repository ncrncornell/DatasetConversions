...
This is a one step process to convert SAS to SPSS using sas script. With this type of conversion, CED2AR program is unable to process variable level summary statistics.
